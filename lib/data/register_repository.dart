...
class RegisterRepository {
  ...
  Future<List<Register>> fetch(int page) async {
    var mockEvents = [
      ...
      Register(title: "Calçada da Pc. Rui Barbosa com defeito", description: "Calçado da Pc. Rui Barbosa com defeito, pedras soltas...", dateTime: DateTime.now().add(new Duration(days: -30)), status: Status.open),
